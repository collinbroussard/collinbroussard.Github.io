var level01 = function (window) {
  ...
  window.opspark.runLevelInGame = function(game) {
      ...
      createSawBlade(3279,411)
      createSawBlade(767,402)
      createSawBlade(932,432)
      ...
      createEnemy = function(x,y) {
          ...
          createEnemy(1550,groundY-50)
          createEnemy(1300,groundY-75)
          createEnemy(1288,groundY-90)
          ...
          function createReward(x,y) {
            ...
            createReward(690,groundY-210)
            createReward(1450,groundY-70)
